...
function tileContaining(point: PixelPoint, reference: GeoRasterReference): GeoRasterTile | null {
	return (
 ...
 */
export function pixelToGeo(point: PixelPoint, reference: GeoRasterReference): GeoPoint {
