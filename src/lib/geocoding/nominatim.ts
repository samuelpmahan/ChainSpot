 ...
 *
 * Demoted to fallback behind the Google provider (see `../geocodeSearch.ts`):
 * Nominatim lacks several disc golf courses that Google Places knows about.
 *
...
export async function searchNominatim(
	...
	return { ok: true, matches, providerName: 'nominatim' };
}

/** Nominatim geocoding provider: free, public, no key, US-scoped, fallback behind Google. */
